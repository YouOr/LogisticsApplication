...
public class AudioRecordUtils {
	...
	private void creatAudioRecord() {
		...
		audioRecord = new AudioRecord(AudioFileUtils.AUDIO_INPUT, AudioFileUtils.AUDIO_SAMPLE_RATE, AudioFileUtils.CHANNEL_CONFIG, AudioFileUtils.AUDIO_FORMAT, bufferSizeInBytes);
	}
	...
	class AudioRecordThread implements Runnable {
		...
		public void run() {
			...
			AudioFileUtils.raw2spx(mAudioRaw, mAudioSpx);//将raw转化为spx文件
//			AudioFileUtils.spx2raw(mAudioSpx, AudioFileUtils.getDecodeRawFilePath()); //将spx文件转化为raw文件
			AudioFileUtils.raw2Wav(mAudioRaw, AudioFileUtils.getDecodeWavFilePath(), bufferSizeInBytes);
		}
	}
